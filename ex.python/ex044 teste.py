...
time.sleep(2)
if escolha == 'OPÇÃO 4':
    np = int(input('Em quantas parcelas você vai pagar?'))
    pc = ccc/np
    print('Considerando 20%, você pagará um total de {} em {} parcelas de {}.'.format(ccc,np,pc))
if escolha == 'OPÇÃO 1':
    ...
    print('Opção invalida, diga a opção corretamente')
